...
export type StatCardVariant = "indigo" | "emerald" | "blue" | "amber" | "rose";
    ...
    >
      ...
      {(description || trend) && (
        <div className="mt-4 flex items-center gap-2 text-xs">
          {trend && (
            <span
              className={`inline-flex items-center font-extrabold px-2.5 py-0.5 rounded-full text-[11px] border ${
                trend.positive
