...
export function ContactCell({student}) {
  ...
  return (
    ...
    <div
                ...
                className="absolute right-0 z-50 mt-2 w-48 overflow-hidden rounded-md border bg-white shadow-lg leading-6"
            >
              <a
                  role="menuitem"
  ...
  <rect x="16" y="25" width="12" height="3" rx="1.5" fill="#ffffff" />
</svg>
