...
export default function AvailableSubjectsPanel({
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      {selectedSubject && (
        <div className="mt-4 flex items-center justify-between rounded-xl border border-indigo-100 bg-indigo-50/50 px-4 py-3 text-sm text-indigo-700 animate-in fade-in slide-in-from-top-2">
          <span>
            Assigning: <span className="font-semibold text-indigo-900">{selectedSubject.subject_name}</span>
          </span>
          <span className="text-xs font-medium bg-indigo-100 px-2 py-0.5 rounded text-indigo-600">
