...
const links = [
  { href: "/admin/dashboard", label: "My Dashboard", icon: "👩‍🏫" },
  { href: "/admin/list_students", label: "Students", icon: "🎓" },
];
      ...
      <div className="flex h-auto flex-col justify-between ">
        ...
        <div>
          <div className="flex items-center justify-between p-3">
            <div className={"text-md font-semibold text-card-foreground overflow-hidden " + (expanded ? "opacity-100" : "opacity-0 pointer-events-none")}>
              Menu
            </div>
            <button
              type="button"
