...
import {PasswordStrengthBar} from "@/src/utils/password_strength"
...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-dvh place-items-center p-6 bg-slate-400">
      <div className="w-full max-w-sm rounded-lg border bg-slate-100 p-4 pt-3 pb-3 shadow-sm text-slate-800 text-md font-mono">
