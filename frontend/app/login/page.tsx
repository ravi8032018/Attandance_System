...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-dvh place-items-center p-6 bg-purple-200">
      <div className="w-full max-w-sm rounded-lg border bg-slate-100 p-4 pt-3 pb-3 shadow-sm text-black text-md ">
        ...
        {err ? <p className="text-md text-center text-red-600  px-1 py-0">Email or password incorrect &nbsp; &nbsp;</p> : null}
        <form onSubmit={onSubmit} className="space-y-5 ">
          ...
          <button
            disabled={loading}
            className="w-full rounded-md bg-indigo-600 px-3 py-2 text-white  hover:bg-indigo-700 disabled:opacity-60"
          >
