        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col sm:items-end sm:justify-end pt-21">
              ...
              <button onClick={() => setTab("attendance")} className="rounded-md border border-indigo-600 bg-indigo-600 px-3 py-2 text-sm text-white hover:bg-indigo-700 shadow-sm hover:shadow-md">
                View Attendance
                </button>
